...
class ChatGPTScreen extends StatefulWidget {
  final String? initialText; // Accept initial text as a parameter
  ChatGPTScreen({this.initialText});
...
class _ChatGPTScreenState extends State<ChatGPTScreen> {
  ...
  void initState() {
    ...
    if (widget.initialText != null) {
      _textEditingController.text = widget.initialText! + "   "  +  " Generate 30 questions and answers on above context and mention questions with Q and answers with A";
    }
  }
  ...
  void onSendMessage() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ChatGptResponsePage(response: response),
      ),
    );
